...
const InProgress = () => {
  ...
  return (
    <div className="mt-[70px]">
      <h1 className="text-2xl font-bold mb-2">In Progress Tasks</h1>
      <h2 className="text-black mb-2">Here is list of tasks that you are working on</h2>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-gray-200">
          ...
          <tbody>
            ...
            ))): "you don't have in progress task"}
          </tbody>
        </table>
      </div>
